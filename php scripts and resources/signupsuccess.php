      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item active">
            <a >Register<span class ="sr-only">(current)</span> </a>
          </li>
...
<div class="margin-top-60 margin-top-100">
    <div class="col-md-12">
                    <center>
                        ...
                        <br>
                        <br>
                        <h1 class="title-cag margin-bottom-10">Registration Successful !!!</h1>
                        <p>Click Next to Log in to your account.</p>
                    </center>

                    <center>
                      <a href="login.php" class="btn btn-success" > Next </a>
                      </center>
                      <br><br><br>
